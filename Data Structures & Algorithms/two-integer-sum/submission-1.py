#Set: Directly iterated using for element in my_set.
#Dictionary (Hash): Iterated with .items() to get keys and values.
#List (Array): Iterated using range and len for indexed access.
